...
with st.expander("Clique para ver explicação dos indicadores"):
    st.markdown("""
    🎯 **Meta Mensal**  
    Valor objetivo de faturamento no mês.
    ...
    🛒 **Ticket Médio**  
    Valor médio por pedido (Faturamento ÷ Nº de pedidos).
    """)

    st.info(f"""
📊 Você atingiu {atingimento_meta:.1f}% da meta.

💰 Faltam R$ {meta_mensal - faturamento_total:,.2f} para atingir o objetivo.

📈 Margem atual: {margem:.2f}%
""")
